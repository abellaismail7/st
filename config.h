 ...
 */
static char *font = "Jetbrains Mono:style=Bold:pixelsize=10:antialias=true:autohint=true";
static char *font2[] = { "Almarai:pixelsize=10:antialias=true:autohint=true" };
